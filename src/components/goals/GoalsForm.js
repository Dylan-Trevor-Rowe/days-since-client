...
export const GoalsForm = (props) => {
  ...
  return <>
    ...
    <div className="goal_input">
      <TextField
        style={{ backgroundColor: 'white' }}
        name="goal_name" defaultValue={localState.goal_name}
        value={localState.goal_name}
        type="input"
        id="standard-basic"
        onChange={handleControlledInputChange} />
    </div>
    ...
    <div className="goal_input">
      <TextField
        style={{ backgroundColor: 'white' }}
        type="input" id="standard-basic"
        name="goal_length"
        defaultValue={localState.goal_length}
        value={localState.goal_length}
        onChange={handleControlledInputChange} />
    </div>
    <div className="goal_labels">
      <h4>goal reason</h4>
    ...
    <div className="goal_input">
      <TextField
        ...
        multiline
        name="goal_reason"
        defaultValue={localState.goal_reason}
        value={localState.goal_reason}
        onChange={handleControlledInputChange}
        rows={8}
        rowsMax={10}
      />
    ...
    <div className="button_container">
      <Button onClick={constructANewGoal}
