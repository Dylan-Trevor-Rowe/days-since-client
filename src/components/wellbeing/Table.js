  ...
  return (
    <TableContainer component={Paper}>
      <Table className={classes.table} aria-label="simple table">
        <TableHead>
          <TableRow>
            <TableCell style={{ fontFamily: 'Tinos', fontSize: 'larger' }}>
              All Time averages
            </TableCell>
            <TableCell style={{ fontFamily: 'Tinos', fontSize: 'larger' }}
              align="right">
        ...
        <TableBody>
          <TableRow>
            ...
            <TableCell style={{ fontFamily: 'Tinos', fontSize: 'larger' }}
              align="right">{hoursOfSleepData} hrs
            </TableCell>
            <TableCell style={{ fontFamily: 'Tinos', fontSize: 'larger' }}
              align="right">{painScaleData}
            </TableCell>
            <TableCell style={{ fontFamily: 'Tinos', fontSize: 'larger' }}
              align="right">{fatigueScaleData}
            </TableCell>
            <TableCell style={{ fontFamily: 'Tinos', fontSize: 'larger' }}
              align="right">{emotionalWellBeingData}
            </TableCell>
          </TableRow>
        </TableBody>
      </Table>
