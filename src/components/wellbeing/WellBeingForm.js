            ...
            <div className='checkbox'>
              <div>
                ...
                {<input
                  ...
                  name="noSymptoms"
                  onChange={toggle}
                  defaultChecked={defaultvalues.noSymptoms
                    && defaultvalues.noSymptoms} />}
              </div>
              <div>
                ...
                {<input
                  ...
                  name="numbness"
                  onChange={toggle}
                  defaultChecked={defaultvalues.numbness
                    && defaultvalues.numbness} />}
              </div>
              <div>
                ...
                {<input
                  ...
                  name="tingling"
                  onChange={toggle}
                  defaultChecked={defaultvalues.tingling
                    && defaultvalues.tingling} />}
              </div>
            </div>
            <div className='checkbox'>
              <div>
                ...
                {<input
                  ...
                  name="weakness"
                  onChange={toggle}
                  defaultChecked={defaultvalues.weakness
                    && defaultvalues.weakness} />}
              </div>
              <div>
                ...
                {<input
                  ...
                  name='stiffness'
                  onChange={toggle}
                  defaultChecked={defaultvalues.stiffness &&
                    defaultvalues.stiffness} />}
              </div>
              <div>
                ...
                {<input
                  ...
                  onChange={toggle}
                  defaultChecked={defaultvalues.coordinationOrBalanceProblems
                    && defaultvalues.coordinationOrBalanceProblems} />}
              </div>
            </div>
            <div className='checkbox'>
              <div>
                ...
                {<input
                  ...
                  onChange={toggle}
                  defaultChecked={defaultvalues.heatSensitivity
                    && defaultvalues.heatSensitivity} />}
              </div>
              <div>
                ...
                {<input
                  ...
                  name="incontenance"
                  onChange={toggle}
                  defaultChecked={defaultvalues.incontenance
                    && defaultvalues.incontenance} />}
              </div>
              <div>
                <label
                ...
                {<input type="checkbox"
                  name="brainFog"
                  onChange={toggle}
                  defaultChecked={defaultvalues.brainFog
                    && defaultvalues.brainFog} />}
              </div>
            </div>
          </div>
    ...
    return <>
      ...
      <div className='checkbox_container'>
        <div className='checkbox'>
          <div>
            <label 
            style={{ fontFamily: 'Belleza' }} >none</label>
